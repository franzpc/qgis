...
2.5beta: Added Global Curve Number tool. Fixed the bug that did not calculate the coordinates for the last row (thanks to @russ-go), compensated slope suggested by Fernando Oñate.
